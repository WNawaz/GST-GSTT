...
str p_suffix):
    ...
    if p_suffix != 'No':
        ...
        OUP_PFM = f'{p_inpnet}_pfm_{p_method}_{str(p_tolerance).split(".", 1)[0] + str(p_tolerance).split(".", 1)[1]}_S{str(p_scaling).split(".", 1)[0] + str(p_scaling).split(".", 1)[1]}_CyO_{p_suffix}.npy'
    else:
        INP_E23W = f'{p_inpnet}_S{str(p_scaling).split(".", 1)[0] + str(p_scaling).split(".", 1)[1]}_e23w_G23w_CyO.npy'
        OUP_PFM = f'{p_inpnet}_pfm_{p_method}_{str(p_tolerance).split(".", 1)[0] + str(p_tolerance).split(".", 1)[1]}_S{str(p_scaling).split(".", 1)[0] + str(p_scaling).split(".", 1)[1]}_CyO.npy'
